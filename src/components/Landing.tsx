...
const Landing: React.FC<NavigationBarProps> = ({ projectsRef }) => {
  ...
  return (
    <>
      <div className="h-dvh lg:h-[70vh] border-4 lg:border-b-0 border-[#411E31] border-double bg-[#FFE3F933] flex flex-col gap-4 md:gap-2 lg:gap-8 justify-center items-center px-2 lg:px-8">
        ...
        <div className="sborder-2 interFont text-[#F4EFEF] Sbg-gradient-to-r from-[#411E31] to-[#863373] bg-[#411E31]  text-sm lg:text-base xl:text-lgs font-medium p-3 tab:p-4 rounded-lg transition ease-in-out duration-500 delay-10 cursor-pointer hover:scale-[1.04] animate-pulses">
